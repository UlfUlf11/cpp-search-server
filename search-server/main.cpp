...
public:
    ...
    //функция принимает вторым параметром лямбда-функцию из примеров main'а
    ...
    vector<Document> FindTopDocuments(const string& raw_query,Function function) const {
        ...
        //раньше сортировал по убыванию релевантности, а теперь - по рейтингу, а уже потом по релевантности
    ...
    //старая функция FindTopDocuments
    /*
    ...
    */
    ...
    //новая версия с одним параметром
    vector<Document> FindTopDocuments(const string& raw_query, DocumentStatus status = DocumentStatus::ACTUAL) const {
        return FindTopDocuments(raw_query,
            [&status](int id, DocumentStatus status_doc, int rating) {
