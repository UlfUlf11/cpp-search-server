...
//дл€ макросов ASSERT и ASSERT_HINT
...
//ƒобавление документов. ƒобавленный документ должен находитьс€ по поисковому запросу,
...

{
    ...
    // добавл€ем документ и провер€ем что его можно найти по любому слову из документа
...
//ѕоддержка минус-слов.

//ƒокументы, содержащие минус-слова поискового запроса, не должны включатьс€ в результаты поиска.
...
//ћатчинг документов. ѕри матчинге документа по поисковому запросу должны быть возвращены все слова из поискового запроса,
...
//¬озвращаемые при поиске документов результаты должны быть отсортированы в пор€дке убывани€ релевантности.
...
//тест провер€ет, что функци€ возвращает документы с использованием предикаты, задаваемой пользователем
